...
def seed():
    ...
    model.update_or_add(dict(id=1,name='student',description="Student"), model.AppType)
    model.update_or_add(dict(id=2,name='nonstudent',description="Non-student"), model.AppType)

    model.update_or_add(dict(id=1,name='bachelors',description="Bachelor's"), model.Degree)
    model.update_or_add(dict(id=2,name='masters',description="Master's"), model.Degree)
    model.update_or_add(dict(id=3,name='phd',description="Ph.D."), model.Degree)

    model.update_or_add(dict(id=1,name='male',description="Male"), model.HousingPref)
    model.update_or_add(dict(id=2,name='female',description="Female"), model.HousingPref)
    model.update_or_add(dict(id=3,name='decline',description="Decline"), model.HousingPref)
    model.update_or_add(dict(id=4,name='unknown',description="Unknown"), model.HousingPref)
